 ...
 * 
 * A component that adds a new to-do or edits a selected to-do.
*/
export default {
  name: 'ToDoDetail',
  ...
  globalStore:{
    ...
    selectedTodoId:{
         ...
         * 
         * onReceived method is a callback called after the related data option variable receives a new value.
        */
        onReceived: function(val) {
            console.log('onSelectedTodoIdReceived()', val);
            //템플릿에서 입력 컴포넌트들의 v-model에 바인딩할 todo 값을 설정함.
            //Assign a value to the todo variable for binding to the v-model of input components in the template.
